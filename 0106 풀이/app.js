...
//     if((word.includes('shit')) || (word.includes('shit'))){
//         return '💩' 
...
// novel.split('').forEach((c) =>{
//     const c1 = c.toLowerCase() 
//     if (specialCharacters.includes(c1) || c1 === '\n' || c1 ===' ')return
//     if(!classified[c1]) classified[c1] = 0
//     classified[c1]++
// })
...
//         .split(' ')
//         .map(word =>{
//             //가사가 사용자 검색어를 포함하면 검색어에 하이라이트를 적용
...
// displayLyrics(lyrics) //화면 초기 렌더링
